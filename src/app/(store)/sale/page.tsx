...
import { Sale } from "@/sanity/lib/sale";

export default async function sale() {
  const products: Product[] = await Sale();
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex items-center px-[6rem] space-x-2 text-lg py-4">
        ...
        <span className="font-bold text-black">Sale</span>
      </div>
      ...
      <div className="flex flex-col items-center justify-start md:p-4">
        <div className="flex w-full">
          ...
          <div className="flex-3">
            ...
            <h1 className="mt-4  md:mt-8 md:text-4xl  text-2xl font-extrabold">Sale</h1>
