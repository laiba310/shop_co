...
import { Arrival } from "@/sanity/lib/arrival";
...
export default async function Arrivall() {
  const products: Product[] = await Arrival();
      ...
      <div className="flex flex-col items-center justify-start md:p-4">
        <div className="flex w-full">
          ...
          <div className="flex-3">
            ...
            <h1 className="mt-4  md:mt-8 md:text-4xl  text-2xl font-extrabold">New Arrival</h1>
