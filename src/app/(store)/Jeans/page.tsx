...
export default async function jeans() {
  ...
  return (
    <div className="min-h-screen md:p-8">
        ...
        <span className="text-gray-500">/</span>
        <span className="font-bold text-black">Jeans</span>
      </div>
      <h1 className="text-3xl font-bold text-center mb-6">Jeans Collection</h1>
