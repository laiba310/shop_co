...
export default function FilterOnly() {
  // Define the filters state with explicit types for colors and sizes
  const [filters, setFilters] = useState<{
    ...
    category: "",
    priceRange: [0, 500], // Default price range as a tuple
    colors: [],
    sizes: [],
  });
    ...
    <>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="mb-4">
          ...
          <Link href="/shirt" className="flex justify-between items-center mb-2">
          ...
          <Link href="/Jeans" className="flex justify-between items-center mb-2">
            <div className="flex flex-wrap opacity-55">Jeans</div>
            <ChevronRight className="opacity-50" />
          </Link>
        </div>
